...
/**
 * Crossword.in Top 50 Books Importer (Final Version with Assets)
...
// Use existing asset for all books (we'll use the one we found)
const DEFAULT_BOOK_ASSET = {
  uid: 'blt444a0c877cc245f1',
  url: 'https://images.contentstack.io/v3/assets/blte1f8c41539d5f7e3/blt444a0c877cc245f1/68ecb2836957647ae49b2ec3/Atonment.jpg',
  title: 'Atonment.jpg'
};
  ...
  try {
    const entryData = {
      entry: {
        ...
        tags: bookData.tags,
        bookimage: {
          uid: DEFAULT_BOOK_ASSET.uid,
          url: DEFAULT_BOOK_ASSET.url,
          title: DEFAULT_BOOK_ASSET.title
        }
      }
    };
...
async function importCrosswordBooks() {
  ...
  console.log(`📸 Using asset: ${DEFAULT_BOOK_ASSET.title} (${DEFAULT_BOOK_ASSET.uid})`);
  console.log('');
...
switch (command) {
  ...
  case 'help':
  default:
    console.log('📚 Crossword.in Books Importer (Final Version)');
    console.log('');
    console.log('Usage:');
    console.log('  node crossword-final.js <command>');
    console.log('');
    ...
    console.log(`📸 Using existing asset: ${DEFAULT_BOOK_ASSET.title}`);
    console.log('');
    console.log('📋 Book Categories Included:');
    console.log('  ✅ Biography & Self-Help (Psychology of Money, Atomic Habits, etc.)');
    console.log('  ✅ Thrillers (Dan Brown, Alex Michaelides, etc.)');
    ...
    console.log('  ✅ Literary Fiction (Where the Crawdads Sing, etc.)');
    console.log('  ✅ Romance (It Ends With Us, Evelyn Hugo, etc.)');
